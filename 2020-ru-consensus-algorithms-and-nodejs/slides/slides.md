...
* Локальные монотонные часы доступны, но не помогут, например, при разрешении коллизий
...
* P.S. А еще есть FLP result (1985), доказывающий невозможность гарантированного достижения консенсуса за ограниченное время в асинхронных системах (🤯)
