...
* Реализации часто называют replicated state machine
* Можно показать, что linearizability и алгоритмы консенсуса (а еще total order broadcast) можно свести друг к другу
