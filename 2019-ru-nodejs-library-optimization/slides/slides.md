...
* Слишком много аллокаций буферов
* TODO: пояснить
* Делаем PoC с полумерами
...
* Нужно избавиться от лишних аллокаций в будущих релизах
* А что же у нас с зависимостью от размера данных?
