...
* Отправляемся в весну 2019го во времена v0.10
...
* Отправляемся во времена разработки следующего релиза
...
# Уже в который раз включаем 🚗 ⌚

* И возвращаемся в настоящее
* Помните про аллокации `Buffer`?
...
* Apple vs. apple: при сравнении стоит идти небольшими шагами, поэтапно
...
* Если вы что-то оптимизировали N месяцев назад, но о текущей производительности не известно ничего
...
###### Выбирайте оптимизированные<br/>приложения/библиотеки/фреймворки в ваших проектах :)
